...
<head>
    ...
    <style>
       ...
       .card 
        ...
        .loginTake a button,input[type="submit"]
        {
           height:6.9vh;
           width:20vw;
           font-size:16px;
        ...
        .loginTake #picture img
        {
        	border-radius:50%;
        }
        .loginTake input[type="digit"]
        {
        	height:6vh;
        	width:20vw;
        	font-size:16.5px;
    ...
    <hr>
        <section class="loginAsk">
            <div class="loginTake">
                ...
                <form name="form4" method="post" action="atmentrycheck.jsp">
                <input type="digit" name="pin" id="pin" required placeholder="Enter pin number"><br>
                <input type="submit" value="submit">
                </form>
                <a href="customerpage.jsp"><button>Exit Atm</button></a><br>
           <%
