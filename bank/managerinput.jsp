    ...
    <hr>
        <section class="loginAsk">
            <div class="loginTake">
                ...
                <form name="form1" method="get" action="managerdatacheck.jsp">
                <input type="digit" placeholder="Enter your id:" id="mid" name="mid" required><br>
                <input type="password" placeholder="Enter password" id="mpass" name="mpass" required><br>
