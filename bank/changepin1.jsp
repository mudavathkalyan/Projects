...
<head>
    ...
    <style>
       ...
       .card 
        ...
        .atminterface table td
        {
            height:60vh;
            width:13vw;
        }
        .atminterface table td a button
        {
            width:47%;
            height:12%;
            margin-left:50px;
        ...
        .atminput input[type="digit"]
        {
            margin-left:10px;
            height:38px;
            font-size:16px;
        }
        .atminput input[type="submit"]
        {
            padding:7px;
            font-size:15px;
            margin-top:20px;
...
<body>
    <nav>
        <ul>
            ...
            <li class="hide"><a href="#" id="loginvisible" onclick="loginshow()">Atm</a></li>
        ...
        <ul class="sidebar">
            ...
            <li><a href="#" id="loginvisible">Atm</a></li>
        </ul>
    </nav>
    ...
    <hr>
         <section class="loginAsk">
            <div class="loginTake">
              <h3>Mini ATM</h3>
              <div class="atminterface">
              		<table width="100%" border="0">
                        <tr>
                            <td class="atminput" >
                                <h4>pin change</h4>
                                <form name="form8" action="changepindo1.jsp" method="post">
                              <input type="digit" placeholder="Enter old pin" required id="opin" name="opin"><br><br>
                               <input type="digit" placeholder="Enter new pin" required id="npin" name="npin"><br>
                                    <input type="Submit" value="changePin">
                                </form>
                            </td>
                            <td>
                                <a href="withdraw1.jsp"><button>Withdraw</button></a><br>
                                 <a href="deposit1.jsp"><button>Deposit</button></a><br>
                                <a href="checkbalance1.jsp"><button>Check balance</button></a><br>
                                <a href="transfer1.jsp"><button>TransferMoney</button></a><br>
                                <a href="changepin1.jsp"><button>ChangePin</button></a><br>
                 ...
                 <a href="customerpage.jsp" id="atmexit"><button>Exit Atm</button></a><br>
            </div>
        </section>
...
%>
    ...
    <section  class="contact" id="contact">
        ...
        <div class="contactform">
            ...
            <form name="form2" action="contactinsert.jsp" method="post">
            <input type="email" id="email" name="email" placeholder="Enter your mail id:"><br>
            <input type="text" id="reason" name="reason" placeholder="Enter the Reason of your contact.">
            <br>
