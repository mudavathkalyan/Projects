              ...
              <div class="atminterface">
              		<table width="100%" border="0">
                        <tr>
                            <td class="atminput" >
                                <h4>MoneyTransfer</h4>
                                <form name="form1" action="transfercheck1.jsp" method="post">
                               	<input type="digit" placeholder="AccountNo to whom transfer:" required id="acc" name="acc"><br><br>
                                    <input type="digit" placeholder="Enter amount" required id="tamt" name="tamt"><br>
