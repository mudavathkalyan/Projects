...
<head>
    ...
    <style>
       ...
       .card 
        ...
        .loginTake input[type='digit'],input[type="password"]
        {
           height:6.4vh;
           width:18.5vw;
           font-size:15px;
...
<body>
    ...
    <hr>
        ...
        <section class="loginAsk">
            <div class="loginTake">
                ...
                <form name="form1" method="get" action="customerdatacheck.jsp">
                <input type="digit" placeholder="Enter Account no:" id="accno" name="accno" required><br>
			...
			if(msg!=null)
            {
                out.println("<font size=3 color=black>"+msg+"</font>");
                out.println("Not having Account then ");
                out.println("<a href='signup.html'>CreateAccount</a>");
            }
			%>
            </div>
        </section>
    ...
    <div class="updates" id="updates">
       ...
       <div class="updatebox">
            ...
            <ul class="unorder">
                <br>
             <li>Be aware of fraud loan apps</li>
             <li>Don't share OTP with any one.</li>
             <li>Dont share pin of your ATM with any one</li>
            </ul>
    </div>
    </div>
